...
<html lang="es-MX">
<head>
	<title>Todas Solicitudes 2/3</title>
		...
		<!-- Start Body -->
			<!-- Start Form -->
				<div class="panel-body" id="conten" style="display:none">
					...
					<div class="col-md-8">
						<h3 style="text-align:center"><b>TODAS SOLICITUDES 2/3</b></h3><hr><br>
					</div>
					<div class="col-md-2"> </div>
...
<table class="table table-bordered table-hover">
	<thead>
		<tr class="bg0">
			...
			<th style="text-align:center"><b>GIRO</b></th>
			<th style="text-align:center"><b>ESTABLECIM</b></th>
			<th style="text-align:center"><b>PRED</b></th>
			<th style="text-align:center"><b>OCUP</b></th>
			<th style="text-align:center"><b>EST</b></th>
			<th style="text-align:center"><b>EMP</b></th>
			<th style="text-align:center"><b>INVERS</b></th>
			<th style="text-align:center"><b>ANT</b></th>
			<th style="text-align:center"><b>EDAD</b></th>
			<th style="text-align:center"><b>SERV</b></th>
		</tr>
	</thead>
	<tbody>
<?php
...
?>
		<tr class="<?php echo $estilo ?>">
			...
			<td align="center"><?php echo $row['establecimiento']; ?></td>
			<td align="center"><?php echo $row['sup_predio']; ?></td>
			<td align="center"><?php echo $row['sup_ocupar']; ?></td>
			<td align="center"><?php echo $row['caj_est']; ?></td>
			<td align="center"><?php echo $row['n_emp']; ?></td>
			<td align="center"><?php echo $row['s_inversion']; ?></td>
			<td align="center"><?php echo $row['antiguedad']; ?></td>
			<td align="center"><?php echo $row['edad_sol']; ?></td>
			<td align="center"><?php echo $row['servicios']; ?></td>
		</tr>
<?php	} ?>
	</tbody>
</table>
...
<?php	} ?>
				...
				<div class="col-md-12"> </div>
					...
					<div class="col-md-8" style="text-align:center">
						...
						<a href="#nav" class="btn btn-success" style="width:30%">2/3</a>
						<a href="tabladat.php" class="btn btn-primary" style="width:30%">3/3</a>
					</div>
					<div class="col-md-2"> </div>
				</div><!-- panel-body -->
			<!-- Finish Form -->
