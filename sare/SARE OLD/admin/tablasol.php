...
<html lang="es-MX">
<head>
	<title>Todas Solicitudes 1/3</title>
		...
		<!-- Start Body -->
			<!-- Start Form -->
				<div class="panel-body" id="conten" style="display:none">
					...
					<div class="col-md-8">
						<h3 style="text-align:center"><b>TODAS SOLICITUDES 1/3</b></h3><hr><br>
					</div>
					<div class="col-md-2"> </div>
...
<table class="table table-bordered table-hover">
	<thead>
		<tr class="bg0">
			...
			<th style="text-align:center"><b>RAZON SOC</b></th>
			...
			<th style="text-align:center"><b>MUNICIPIO</b></th>
		</tr>
	</thead>
	<tbody>
<?php
...
?>
		<tr class="<?php echo $estilo ?>">
			...
			<td align="center"><?php echo $row['dp_calle']; ?></td>
			<td align="center"><?php echo $row['dp_col']; ?></td>
			<td align="center"><?php echo $row['dp_mpio']; ?></td>
		</tr>
<?php	} ?>
	</tbody>
</table>
...
<?php	} ?>
				...
				<div class="col-md-12"> </div>
					...
					<div class="col-md-8" style="text-align:center">
						<a href="#nav" class="btn btn-success" style="width:30%">1/3</a>
